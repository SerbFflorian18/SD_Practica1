...
class ChatServerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendMessage = channel.unary_unary(
                '/server_V0.ChatServer/SendMessage',
        ...
        self.ReceiveMessage = channel.unary_unary(
                '/server_V0.ChatServer/ReceiveMessage',
        ...
        self.ConnectToChat = channel.unary_unary(
                '/server_V0.ChatServer/ConnectToChat',
        ...
        self.SubscribeToGroupChat = channel.unary_unary(
                '/server_V0.ChatServer/SubscribeToGroupChat',
...
def add_ChatServerServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'server_V0.ChatServer', rpc_method_handlers)
...
class ChatServer(object):
    ...
    def SendMessage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/server_V0.ChatServer/SendMessage',
    ...
    def ReceiveMessage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/server_V0.ChatServer/ReceiveMessage',
    ...
    def ConnectToChat(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/server_V0.ChatServer/ConnectToChat',
    ...
    def SubscribeToGroupChat(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/server_V0.ChatServer/SubscribeToGroupChat',
